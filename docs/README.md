...
PPTX, SVG and PNG together. The UI tour uses a prepared sample project connected to a
live Gateway. Its [recording guide](assets/ui/README.md) documents the fixture and
capture commands; update the clips, posters and bilingual tour copy together.
