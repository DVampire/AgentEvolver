...
`workflow__<name>` function. It can call `inspect_tool` (capability_type="workflow") for the complete HTML and
...
Built-ins live in `agentevolver/workflow/default/*.html`; project extensions live in
