    ...
    def _dispatch_parameters() -> Dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                ...
                "target_type": {"type": "string", "enum": ["tool", "skill", "agent", "connector", "memory", "plugin", "workflow", "environment"], "description": "Which kind of component a capability change concerns — used when a dispatched run is about creating, improving or judging one. A change to a component that does not exist yet cannot be looked up, so leaving this unstated means the run cannot install what it built."},
