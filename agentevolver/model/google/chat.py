...
from agentevolver.model.google.serializer import GoogleChatSerializer
...
class ChatGoogle(BaseChatModel):
    ...
    async def _parse_stream(self, raw):
        ...
        from agentevolver.model.types import TextDelta, ThinkingDelta, ToolCallComplete, StreamDone, normalize_stop_reason
