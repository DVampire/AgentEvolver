...
const _CODE_TAGS = new Set([
  'output-schema', 'done-tool-schema', 'memory-format',
  'tool-format-schema', 'skill-format-schema',
  'available-tools-format', 'available-skills-format',
