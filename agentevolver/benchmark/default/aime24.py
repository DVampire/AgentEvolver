...
from agentevolver.data.aime24 import AIME24Dataset
...
class AIME24Benchmark(Benchmark):
    ...
    path: str = Field(default=AIME24Dataset.default_path, description="The path to the benchmark dataset")
    hf_repo_id: str = Field(default=AIME24Dataset.hf_repo_id, description="HuggingFace repo to download the dataset from when it is missing locally.")
