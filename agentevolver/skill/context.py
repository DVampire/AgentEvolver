...
class SkillContextManager(BaseModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Built-in skills live directly under agentevolver/skill/, grouped into category
    ...
    async def initialize(self, skill_names: Optional[List[str]] = None):
        ...
        # 1. Load all built-in skills. They live directly under agentevolver/skill/, grouped
