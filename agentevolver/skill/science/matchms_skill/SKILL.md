---
name: matchms_skill
description: Process, clean, compare, and search tandem mass spectra with matchms. Use for MS/MS file
  I/O, metadata harmonization, peak filtering, spectral similarity, library matching, score matrices,
  and molecular-similarity networks. Use pyopenms instead for LC-MS feature detection or proteomics pipelines.
version: 2.0.0
type: worker
license: Apache-2.0
category: science
metadata:
  ...
  original-name: matchms
  allowed-tools: Read Write Edit Bash
  compatibility: Requires Python >=3.10,<3.15, uv, and matchms 0.33.1. Local file workflows need no credentials;
    metabolomics-USI loading requires network access.
---
# Matchms
