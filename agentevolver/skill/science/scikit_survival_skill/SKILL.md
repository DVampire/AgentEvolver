---
name: scikit_survival_skill
description: Build, evaluate, and audit right-censored or competing-risk survival workflows with scikit-survival,
  including leakage-safe preprocessing, model selection, probability prediction, and censoring-aware metrics.
version: 1.1.0
type: worker
license: MIT
category: science
metadata:
  ...
  original-name: scikit-survival
  allowed-tools: Read Write Edit Bash
  compatibility: Requires Python 3.11+, uv, and the pinned scikit-survival 0.28.0 stack for executable
    examples. Bundled CLIs are local and network-free by default.
---
# scikit-survival
