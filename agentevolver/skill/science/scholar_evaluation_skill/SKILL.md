---
name: scholar_evaluation_skill
description: Provide qualitative-first, evidence-traceable developmental review of scholarly works and
  audit low-stakes research-assessment rubrics with optional local quality controls. Never use for ranking
  people or consequential decisions.
version: 2.1.0
type: worker
license: MIT
category: science
metadata:
  ...
  original-name: scholar-evaluation
  allowed-tools: Read Write Bash Glob Python
  compatibility: Requires Python 3.11+ for optional bundled standard-library CLIs. All tooling is local
    JSON/CSV processing with no network, credentials, external models, or subprocesses.
---
# Scholar Evaluation
