---
name: zarr_python_skill
description: Chunked N-D arrays for cloud storage (Zarr-Python 3). Compressed arrays, parallel I/O, S3/GCS
  via fsspec, NumPy/Dask/Xarray compatible, for large-scale scientific computing pipelines.
version: 1.2.0
type: worker
license: MIT license
category: science
metadata:
  ...
  original-name: zarr-python
  allowed-tools: Read Write Edit Bash
  compatibility: Requires Python 3.12+ and zarr 3.x. Cloud I/O needs zarr[remote] plus pinned s3fs or
    gcsfs. Legacy Zarr v2 workflows need exact 2.x pins on older Python.
---
# Zarr Python
