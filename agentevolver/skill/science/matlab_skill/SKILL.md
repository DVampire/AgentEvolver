---
name: matlab_skill
description: Build, review, migrate, and safely plan MATLAB or GNU Octave numerical workflows, including
  arrays, tabular/time data, tests, projects, graphics, MAT files, and explicit Python interoperability.
version: 1.1.0
type: worker
license: MIT
category: science
metadata:
  ...
  original-name: matlab
  allowed-tools: Read Write Bash Glob Python
  compatibility: Documentation is pinned where noted to proprietary MATLAB R2026a and free GNU Octave
    11.3.0. Bundled Python CLIs require Python 3.11+ and run locally without MATLAB or Octave; optional
    MAT inventory uses scipy and/or h5py.
---
