---
name: markdown_mermaid_writing_skill
description: Comprehensive markdown and Mermaid diagram writing skill. Use when creating any scientific
  document, report, analysis, or visualization. Establishes text-based diagrams as the default documentation
  standard with full style guides (markdown + mermaid), 24 diagram type references, and 9 document templates.
version: 1.1.0
type: worker
license: Apache-2.0
category: science
metadata:
  ...
  skill-version: 1.0.0
  skill-contributors: Clayton Young (Superior Byte Works, LLC / @borealBytes; Author and originator);
    K-Dense Team (K-Dense Inc.; Integration target and community feedback)
  source: https://github.com/K-Dense-AI/scientific-agent-skills
  original-name: markdown-mermaid-writing
