---
name: molecular_dynamics_skill
description: Run and analyze molecular dynamics simulations with OpenMM and MDAnalysis. Set up protein/small
  molecule systems, define force fields, run energy minimization and production MD, analyze trajectories
  (RMSD, RMSF, contact maps, free energy surfaces). For structural biology, drug binding, and biophysics.
version: 1.1.0
type: worker
license: MIT
category: science
metadata:
  ...
  original-name: molecular-dynamics
---
# Molecular Dynamics
