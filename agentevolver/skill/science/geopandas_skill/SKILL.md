---
name: geopandas_skill
description: Guidance and local audit tools for Python workflows that directly use GeoPandas GeoSeries,
...
metadata:
  ...
  original-name: geopandas
  allowed-tools: Read Write Bash Glob Grep
  compatibility: Requires Python 3.10+ and uv. Bundled CLIs are local-only; runtime analysis requires
    the pinned GeoPandas stack below.
---
# GeoPandas
