---
name: primekg_skill
description: Query the Precision Medicine Knowledge Graph (PrimeKG) for multiscale biological data including
  genes, drugs, diseases, phenotypes, and more.
version: 1.1.0
type: worker
license: Unknown
category: science
