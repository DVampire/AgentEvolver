---
name: benchling_integration_skill
description: Benchling Python SDK and REST API integration for registry entities, inventory, ELN entries,
  workflows, Benchling Apps, and Data Warehouse queries. Use when automating lab data with benchling-sdk
  or the v2 API.
version: 1.4.0
type: worker
license: MIT
...
metadata:
  ...
  original-name: benchling-integration
  allowed-tools: Read Write Edit Bash
  compatibility: Requires a Benchling account, tenant URL, and API key or OAuth app credentials. Install
    benchling-sdk with uv pip install.
---
