---
name: api_and_interface_design_skill
...
- **Plan for deprecation at design time.** See `deprecation_and_migration_skill` for how to safely remove things users depend on.
