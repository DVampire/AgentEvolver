...
- **Degeneration is self-detectable, and recovery is a written-down sequence.** The METR trace
  summarized in [`j-space-science.md`](../j-space-science.md) collapses into repeated
...
| The recovery needs its shape, not its description | `../exemplars.md` | The meltdown you are in |
