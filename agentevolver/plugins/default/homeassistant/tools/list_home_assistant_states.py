"""List Home Assistant States — from the Langflow `homeassistant` bundle (ported)."""
...
class HomeassistantListHomeAssistantStatesPlugin(BundlePlugin):
    name: str = "homeassistant.list_home_assistant_states"
