...
class CleanlabEvaluatorTool(PluginTool):
    ...
    output = {'score': 'any', 'explanation': 'object'}

    def _render(self, data):
        return f"Trust score: {data['score']}."
    ...
    async def __call__(self, prompt: str = "", response: str = "", api_key: str = "", model: str = "gpt-4o-mini", **kwargs) -> Response:
        ...
        return self._ok(score=score, explanation=result.get('log', {}) if isinstance(result, dict) else None)
