...
from src.protocol.types import EscalationMessage, MonitorProgressMessage, ControlMessage, QueryMessage
...
class ProtocolManager(metaclass=Singleton):
    ...
    async def delegate(
        ...
        import os
        from src.agent.types import AgentContext  # local: agent → protocol.server would cycle at import time
