...
On every POST_STEP the step's messages are written to:
    ...
    <default_dir>/messages/<agent_name>/<NNNN>.html   (0001.html, 0002.html, ...)
"""
import os
...
from src.visual import css_path, js_path
...
class SnapshotHook(Hook):
    ...
    async def handle(self, ctx: HookContext) -> HookResult:
        ...
        try:
            ...
            base_dir = str(getattr(config, "default_dir", None) or inp.get("work_dir") or ".")
