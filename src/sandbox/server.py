...
machinery — a sandbox is infrastructure, not an evolvable component. It:
  ...
  * hands out started :class:`~src.sandbox.types.Sandbox` handles by *kind*
...
from src.sandbox.process import shutdown_all
from src.sandbox.types import Sandbox, SandboxConfig
...
class SandboxManagerServer(BaseModel):
    ...
    async def initialize(self) -> None:
        ...
        import src.sandbox.default  # noqa: F401
