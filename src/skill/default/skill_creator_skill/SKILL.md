...
- Skills live in `{project_root}/extension/skill/{skill_name}/` (generated skills) or `src/skill/default/{skill_name}/` (defaults). Use `snake_case` names ending in `_skill`.
- A skill directory:
  ```
  {skill_name}/
