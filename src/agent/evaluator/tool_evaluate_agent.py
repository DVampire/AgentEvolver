...
class ToolEvaluateAgent(Agent):
    ...
    async def _get_agent_context(
        ...
        **kwargs,
        ...
        if tool_name:
            ...
            base["evaluation_target"] = "(no tool_name provided)"
    ...
    async def __call__(
        ...
        **kwargs,
        ...
        logger.info(f"| 🚀 Starting ToolEvaluateAgent: {task} (tool={tool_name})")
        ...
        if tool_config is None:
            logger.warning(f"| ⚠️ Tool '{tool_name}' not found in registry, refusing evaluation")
