...
def parse_args():
    ...
    parser.add_argument(
        "--task",
        default=(
            "Evaluate the counter_environment across all five quality dimensions "
            "(interface compliance, code quality, action quality, integration, functionality) "
...
async def main():
    ...
    await task_manager.initialize(work_dir=task_work_dir, handler=run_evaluate_environment)
