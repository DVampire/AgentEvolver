...
def parse_args():
    ...
    add_task_args(parser, default_task_file=os.path.join(root, "examples", "tasks", "environment_generate.html"))
...
async def main():
    ...
    await task_manager.initialize(log_root=task_log_root, handler=run_generate_environment)
