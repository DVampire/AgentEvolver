...
def parse_args():
    ...
    parser.add_argument("--config", default=os.path.join(root, "configs", "reason_act_agent.py"), help="config file path")
...
async def main():
    ...
    # Example task
    task = "What is the result of 23 multiplied by 47? Please calculate it step by step and show the process." 
    files = []
